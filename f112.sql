...
prompt APPLICATION 112 - Upload test
--
-- Application Export:
--   Application:     112
--   Name:            Upload test
--   Date and Time:   09:54 Tuesday November 21, 2017
--   Exported By:     MASNOGLAVB
--   Flashback:       0
--   Export Type:     Application Export
--   Version:         5.1.1.00.08
--   Instance ID:     218280030728387
--
...
,p_owner=>nvl(wwv_flow_application_install.get_schema,'BK_APEX_MANUAL_CMS')
...
,p_checksum_salt_last_reset=>'20171121085131'
...
,p_authentication_id=>wwv_flow_api.id(5370763443796706)
...
,p_csv_encoding=>'Y'
,p_last_updated_by=>'MASNOGLAVB'
,p_last_upd_yyyymmddhh24miss=>'20171121085131'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(2855797129462558)
,p_plugin_type=>'ITEM TYPE'
,p_plugin=>'NATIVE_COLOR_PICKER'
,p_attribute_01=>'classic'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(2855874648462564)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(2855921269462566)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(2856076736462566)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(2856121815462566)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(2856232555462567)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
...
wwv_flow_api.create_icon_bar_item(
 p_id=>wwv_flow_api.id(5370667661796704)
,p_icon_sequence=>200
...
wwv_flow_api.create_tab(
 p_id=>wwv_flow_api.id(5372181000796719)
,p_tab_set=>'TS1'
,p_tab_sequence=>10
,p_tab_name=>'T_PAGE_1'
,p_tab_text=>'Page 1'
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(5371874165796716)
,p_name=>' Breadcrumb'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(5372279273796720)
,p_parent_id=>0
,p_short_name=>'Page 1'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(5360967284796669)
,p_theme_id=>21
,p_name=>'Login'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(5361064090796672)
,p_theme_id=>21
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(5361175517796672)
,p_theme_id=>21
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(5361251377796673)
,p_theme_id=>21
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(5361355446796673)
,p_theme_id=>21
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(5361470346796673)
,p_theme_id=>21
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(5361556810796674)
,p_theme_id=>21
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(5361659171796674)
,p_theme_id=>21
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(5361773239796674)
,p_theme_id=>21
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(5361874417796674)
,p_theme_id=>21
,p_name=>'Popup'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(5361967765796674)
,p_theme_id=>21
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(5362058245796674)
,p_theme_id=>21
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(5362161008796674)
,p_theme_id=>21
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(5362259144796674)
,p_theme_id=>21
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(5362363064796675)
,p_theme_id=>21
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(5362453737796675)
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(5362573107796676)
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(5362671459796676)
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(5362771733796676)
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(5362861598796676)
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(5362974033796676)
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(5363061264796676)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5363180987796677)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5363257844796679)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5363352077796679)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<div class="borderless-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="bl-top">',
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5363465709796679)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5363573240796679)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5363682225796680)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5363760321796680)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<div class="rounded-corner-region-blank" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="rc-gray-top">',
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5363882506796680)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<div class="tSC">',
'  #BODY#',
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5363963679796680)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5364077523796680)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="rc-gray-top"><div class="rc-gray-top-r">',
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5364173391796680)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="rc-gray-top"><div class="rc-gray-top-r">',
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5364273600796680)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5364367771796680)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5364477833796680)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5364556235796680)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5364665425796680)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<div class="borderless-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="bl-body">#BODY#</div>',
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5364775476796680)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<div class="borderless-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="bl-top">',
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5364864876796680)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5364967782796680)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5365066177796680)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="rc-gray-top"><div class="rc-gray-top-r">',
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5365159841796680)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5365272962796680)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5365374877796680)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5365461236796680)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<div class="rounded-corner-region-alt" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="rc-gray-top"><div class="rc-gray-top-r">',
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5365563983796680)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5365658229796680)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<div class="sidebar-region">',
'<div class="rounded-corner-region-alt" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5365752996796680)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5365869321796680)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5365966449796681)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(5366080016796681)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<div class="rounded-corner-region-wizard" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="rc-gray-top"><div class="rc-gray-top-r">',
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(5366181901796681)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(5366261750796683)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(5366362184796683)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(5366480635796683)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(5366562493796685)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(5366655076796685)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(5366759092796685)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(5366873527796685)
,p_list_template_current=>'<li class="#LIST_STATUS#"><a href="#LINK#"><span>#TEXT#</span></a></li>'
,p_list_template_noncurrent=>'<li class="#LIST_STATUS#"><a href="#LINK#"><span>#TEXT#</span></a></li>'
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(5366973713796685)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(5367081165796685)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(5367166972796685)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(5367258845796685)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(5367378252796685)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<div class="list-item-current">',
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(5367482836796686)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(5367573722796686)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(5367683219796686)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(5367761476796686)
,p_list_template_current=>'<li><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(5367861732796686)
,p_list_template_current=>'<li class="current">#TEXT#</li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(5367952843796686)
,p_list_template_current=>'<li class="current">#TEXT#</li>'
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(5368057679796686)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'    <li class="#LIST_STATUS#">',
'      <span>#TEXT#</span>',
'    </li>'))
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(5368165965796686)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(5368267789796687)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(5368362645796687)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(5368478160796687)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(5368559206796687)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(5368662043796687)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(5368755224796687)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(5368876121796687)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(5368979875796687)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(5369061368796687)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(5369178202796687)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(5369268016796687)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(5369375962796687)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(5369472580796687)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(5369561294796687)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(5369660504796688)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(5369776785796690)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(5370469242796691)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(5369860659796690)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(5370060938796690)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(5370281126796691)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(5370561859796691)
,p_theme_id=>21
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(5361773239796674)
,p_error_template=>wwv_flow_api.id(5361355446796673)
,p_printer_friendly_template=>wwv_flow_api.id(5361967765796674)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_sidebar_display_point=>'REGION_POSITION_02'
,p_login_template=>wwv_flow_api.id(5360967284796669)
,p_default_button_template=>wwv_flow_api.id(5362453737796675)
,p_default_region_template=>wwv_flow_api.id(5365066177796680)
,p_default_chart_template=>wwv_flow_api.id(5364077523796680)
,p_default_form_template=>wwv_flow_api.id(5364173391796680)
,p_default_reportr_template=>wwv_flow_api.id(5365066177796680)
,p_default_tabform_template=>wwv_flow_api.id(5365066177796680)
,p_default_wizard_template=>wwv_flow_api.id(5365966449796681)
,p_default_menur_template=>wwv_flow_api.id(5363573240796679)
,p_default_listr_template=>wwv_flow_api.id(5363963679796680)
,p_default_irr_template=>wwv_flow_api.id(5364665425796680)
,p_default_report_template=>wwv_flow_api.id(5368662043796687)
,p_default_label_template=>wwv_flow_api.id(5369375962796687)
,p_default_menu_template=>wwv_flow_api.id(5369660504796688)
,p_default_calendar_template=>wwv_flow_api.id(5369860659796690)
,p_default_list_template=>wwv_flow_api.id(5367683219796686)
,p_default_option_label=>wwv_flow_api.id(5369375962796687)
,p_default_required_label=>wwv_flow_api.id(5369561294796687)
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(5370763443796706)
...
/
prompt --application/shared_components/plugins/item_type/si_mirmas_filedownloadlink
begin
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(222424405357898183)
,p_plugin_type=>'ITEM TYPE'
,p_name=>'SI.MIRMAS.FILEDOWNLOADLINK'
,p_display_name=>'FileDownloadLink'
,p_supported_ui_types=>'DESKTOP'
,p_supported_component_types=>'APEX_APPLICATION_PAGE_ITEMS'
,p_image_prefix => nvl(wwv_flow_application_install.get_static_plugin_file_prefix('ITEM TYPE','SI.MIRMAS.FILEDOWNLOADLINK'),'')
,p_plsql_code=>wwv_flow_string.join(wwv_flow_t_varchar2(
'--===============================================================================',
'-- Renders the link to disk file download procedure',
'--===============================================================================',
'function RenderDownloadFileLink (',
...
'    l_directory         varchar2(255)  :=  p_item.attribute_01;',
'    l_filename          varchar2(255)  := p_item.attribute_02;',
'    l_mimetype          varchar2(20) := p_item.attribute_03;',
'    l_linktext          varchar2(255)  := p_item.attribute_04;',
'    l_schema            varchar2(30) := nvl(p_item.attribute_05, :OWNER);',
'    l_package           varchar2(30) := p_item.attribute_06;',
'    l_procedure         varchar2(30) := nvl(p_item.attribute_07, ''DownloadFile'');',
'    l_filenotexists     varchar2(255) := p_item.attribute_08;',
'    l_showsize          varchar2(1) := p_item.attribute_09;',
'',
'    l_name              varchar2(30);',
...
'',
'    FUNCTION BYTES2KMGBYTES ',
'    (',
'      P_BYTES IN VARCHAR2  ',
'    ) RETURN VARCHAR2 AS ',
'    ',
'    TYPE T_KMG IS VARRAY(4) OF varchar2(2) NOT NULL;',
'    ',
'    l_power1024 number := 1024;',
'    l_KMG constant T_KMG := T_KMG(''B'',''KB'',''MB'',''GB'');',
'    l_ret varchar2(20);',
'    j number;',
'    BEGIN',
'      for i in 1..l_KMG.count LOOP',
'        j := i;',
'        exit when p_bytes < l_power1024;',
'        l_power1024 := l_power1024 *1024;',
'      END LOOP ;',
'      l_power1024 := l_power1024 / 1024;',
'      if j > 1 then',
'        l_ret := trim(to_char(p_bytes/l_power1024,''9999D99''))||'' ''||l_KMG(j); ',
'      else',
'        l_ret := to_char(p_bytes/l_power1024)||'' ''||l_KMG(j); ',
'      end if;',
'      RETURN l_ret;',
'    END BYTES2KMGBYTES;',
'    ',
...
'        );',
'        ',
'        if not l_exists then --file not exists',
'          if l_filenotexists is not null then',
'            htp.prints(l_filenotexists);',
'          end if;',
'        else ',
'          if l_package is not null then',
'            l_procedure_name := l_schema||''.''||l_package||''.''||l_procedure;',
'          else',
'            l_procedure_name := l_schema||''.''||l_procedure;',
'          end if;',
'  ',
'          -- render the anchor <A HREF="curl">ctext</A>',
'          l_linktext := nvl(l_linktext, l_filename);',
'          if l_showsize = ''Y'' then',
'            l_linktext := l_linktext||'' (''||BYTES2KMGBYTES(l_file_length)||'')''; ',
'          end if;',
'          ',
'          if l_mimetype is null then',
'            HTP.ANCHOR(l_procedure_name||''?p_app_id=''||to_char(:APP_ID)||''&p_directory=''||l_directory||',
'                      ''&p_filename=''||l_filename, l_linktext);',
'          else',
'            HTP.ANCHOR(l_procedure_name||''?p_app_id=''||to_char(:APP_ID)||''&p_directory=''||l_directory||',
'                        ''&p_filename=''||l_filename||''&p_mimetype=''||l_mimetype, l_linktext);',
'          end if;',
'        end if;',
'        ',
...
,p_help_text=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<p>',
'	Plugin display download link to file on server file system.</p>',
''))
,p_version_identifier=>'1.0'
);
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(5378363488851268)
,p_plugin_id=>wwv_flow_api.id(222424405357898183)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>1
,p_display_sequence=>10
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(5378772530851268)
,p_plugin_id=>wwv_flow_api.id(222424405357898183)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(5379152457851268)
,p_plugin_id=>wwv_flow_api.id(222424405357898183)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(5379573105851269)
,p_plugin_id=>wwv_flow_api.id(222424405357898183)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(5379965852851269)
,p_plugin_id=>wwv_flow_api.id(222424405357898183)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>5
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(5380354797851269)
,p_plugin_id=>wwv_flow_api.id(222424405357898183)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>6
,p_display_sequence=>60
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(5380770699851269)
,p_plugin_id=>wwv_flow_api.id(222424405357898183)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>7
,p_display_sequence=>70
...
,p_is_translatable=>false
,p_help_text=>wwv_flow_string.join(wwv_flow_t_varchar2(
'Name of download procedure. Default is DownloadFile. You must implement download procedure with this interface: ',
'',
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(5381178657851269)
,p_plugin_id=>wwv_flow_api.id(222424405357898183)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(5381553625851269)
,p_plugin_id=>wwv_flow_api.id(222424405357898183)
,p_attribute_scope=>'COMPONENT'
...
/
prompt --application/shared_components/plugins/process_type/si_mirmas_savetodisk
begin
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(260283440449985861)
,p_plugin_type=>'PROCESS TYPE'
,p_name=>'SI.MIRMAS.SAVETODISK'
,p_display_name=>'SaveToDisk'
,p_supported_ui_types=>'DESKTOP'
,p_image_prefix => nvl(wwv_flow_application_install.get_static_plugin_file_prefix('PROCESS TYPE','SI.MIRMAS.SAVETODISK'),'')
,p_plsql_code=>wwv_flow_string.join(wwv_flow_t_varchar2(
'function SaveToDisk (',
...
'    end if;',
'    return',
'    SUBSTR(P_FILENAME, 1, INSTR(P_FILENAME, ''.'', -1, 1)-1)|| --do končnice',
'    ''_''||P_STRING|| --srting',
'    SUBSTR(P_FILENAME, INSTR(P_FILENAME, ''.'', -1, 1)); --končnica',
...
'       l_blocksize);',
'     ',
'       if not l_exists then exit; end if; ',
'       l_number := l_number + 1;',
'       l_filename := AddNumberToFilename(l_filename, l_number);',
'     ',
'      end loop;',
'      --rename existing p_filename to l_filename',
'      if P_FILENAME != L_FILENAME then',
...
'    l_overwrite:= upper(p_process.attribute_07) like ''Y%'';',
'   ',
...
'      end if;',
'',
'      Blob2File(l_dbdirectory, l_filename, l_blob, l_overwrite);',
'      delete from wwv_flow_files where name = l_filebrowse;',
...
,p_help_text=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<p>',
'	Process plugin moves uploaded file from WWV_FLOW_FILES table to server disk. Process deletes row from WWV_FLOW_FILES.</p>'))
,p_version_identifier=>'1.0'
);
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(5374383789847694)
,p_plugin_id=>wwv_flow_api.id(260283440449985861)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>1
,p_display_sequence=>10
,p_prompt=>'File Browse Item'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(5374780294847694)
,p_plugin_id=>wwv_flow_api.id(260283440449985861)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(5375155005847694)
,p_plugin_id=>wwv_flow_api.id(260283440449985861)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(5375568760847695)
,p_plugin_id=>wwv_flow_api.id(260283440449985861)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(5375978699847695)
,p_plugin_id=>wwv_flow_api.id(260283440449985861)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>5
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(5376354362847695)
,p_plugin_id=>wwv_flow_api.id(260283440449985861)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>6
,p_display_sequence=>60
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(17313579612570879)
,p_plugin_id=>wwv_flow_api.id(260283440449985861)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>7
,p_display_sequence=>70
,p_prompt=>'Overwrite old file'
,p_attribute_type=>'CHECKBOX'
,p_is_required=>false
,p_default_value=>'N'
,p_is_translatable=>false
,p_help_text=>wwv_flow_string.join(wwv_flow_t_varchar2(
'If choose Yes old file will be overwrited. If choose No old file will be renamed to [filename]_[number].[extension] where number is the first "free" number available. ',
'E.g. Let''s say you want to save file test.txt. On server disk already exists files test.txt, test_1.txt and test_2.txt. ',
'Old file test.txt will be renamed to test_3.txt and new file test.txt will be created.'))
);
end;
/
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(2855605719462524)
,p_ui_type_name=>'DESKTOP'
...
wwv_flow_api.create_page(
 p_id=>1
,p_user_interface_id=>wwv_flow_api.id(2855605719462524)
,p_tab_set=>'TS1'
,p_name=>'Page 1'
,p_page_mode=>'NORMAL'
,p_step_title=>'Page 1'
...
,p_last_updated_by=>'MASNOGLAVB'
,p_last_upd_yyyymmddhh24miss=>'20171120160223'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2950402456025414)
,p_plug_name=>'Old SaveFileToDisk '
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(5365066177796680)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5372353001796722)
,p_plug_name=>'Breadcrumbs'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(5363573240796679)
...
,p_menu_id=>wwv_flow_api.id(5371874165796716)
,p_plug_source_type=>'NATIVE_BREADCRUMB'
,p_menu_template_id=>wwv_flow_api.id(5369660504796688)
,p_plug_query_row_template=>1
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5372555261829944)
,p_plug_name=>'SaveFilesToDisk (APEX 5.1)'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(5365066177796680)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2950558553025415)
,p_button_sequence=>50
,p_button_plug_id=>wwv_flow_api.id(2950402456025414)
,p_button_name=>'P1_SUBMIT_OLD'
,p_button_static_id=>'P1_SUBMIT'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(5362453737796675)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5382774093194961)
,p_button_sequence=>110
,p_button_plug_id=>wwv_flow_api.id(5372555261829944)
,p_button_name=>'P1_SUBMIT_NEW'
,p_button_static_id=>'P1_SUBMIT'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(5362453737796675)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2769608448572630)
,p_name=>'P1_BROWSE_FILE_MULTI'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(5372555261829944)
,p_prompt=>'Browse multiple files'
,p_display_as=>'NATIVE_FILE'
,p_cSize=>30
,p_label_alignment=>'RIGHT-CENTER'
,p_field_alignment=>'LEFT-CENTER'
,p_field_template=>wwv_flow_api.id(5369375962796687)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2769991004572633)
,p_name=>'P1_FILENAME_MULTI'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(5372555261829944)
,p_prompt=>'Filename'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2770071320572634)
,p_name=>'P1_FILEHASH_MULTI'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(5372555261829944)
,p_prompt=>'Filehash'
,p_display_as=>'NATIVE_TEXT_FIELD'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2770375859572637)
,p_name=>'P1_PLUGIN_LOG'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(5372555261829944)
,p_prompt=>'Plugin log'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(5372865997833042)
,p_name=>'P1_FILENAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(2950402456025414)
,p_prompt=>'Filename'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(5373076732836160)
,p_name=>'P1_FILEHASH'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(2950402456025414)
,p_prompt=>'Filehash'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(5382154345113534)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(5382365866173626)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(5382555047189435)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'PLUGIN_SI.MIRMAS.SAVETODISK'
,p_process_name=>'SaveToDisk'
,p_attribute_01=>'P1_BROWSE_FILE'
,p_attribute_02=>'BRLOG_NDMKM_ECMS_INP'
,p_attribute_03=>'test.txt'
,p_attribute_04=>'1 MB'
,p_attribute_05=>'P1_FILENAME'
,p_attribute_06=>'P1_FILEHASH'
,p_attribute_07=>'N'
,p_process_error_message=>'Error when processing SaveToDisk. SQLERRM: #SQLERRM#'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(2950558553025415)
,p_process_success_message=>'SaveToDisk succeeded.'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(2769850938572632)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'PLUGIN_IS.MIRMAS.SAVEFILESTODISK'
,p_process_name=>'SaveToDiskMulti'
,p_attribute_01=>'P1_BROWSE_FILE_MULTI'
,p_attribute_02=>'CR LF'
,p_attribute_03=>'1M'
,p_attribute_04=>wwv_flow_string.join(wwv_flow_t_varchar2(
'BRLOG_NDMKM_ECMS_INP#ADJUSTMENT*###Y#T##bk_apex_manual_cms.pak_cfg.UnskipOpeka(''TSI0287'')',
'BRLOG_NDMKM_ECMS_ARB#jDa_orig_*#jDa_orig_##Y#T##bk_apex_manual_cms.pak_cfg.UnskipOpeka(''TSI0287'')',
'BRLOG_NDMKM_ECMS_ARB#jDa_ORIG_*#jDa_ORIG_##Y#T##bk_apex_manual_cms.pak_cfg.UnskipOpeka(''TSI0287'')',
'BRLOG_NDMKM_ECMS_ARB#orig_jDa_*#orig_##Y#T##bk_apex_manual_cms.pak_cfg.UnskipOpeka(''TSI0287'')',
'BRLOG_NDMKM_ECMS_ARB#ORIG_jDa_*#ORIG_##Y#T##bk_apex_manual_cms.pak_cfg.UnskipOpeka(''TSI0287'')',
'BRLOG_NDMKM_ECMS_ARB#jDa*###Y#T##bk_apex_manual_cms.pak_cfg.UnskipOpeka(''TSI0287'')',
'BRLOG_NDMKM_ECMS_INP#ACQADJ*###Y#T##bk_apex_manual_cms.pak_cfg.UnskipOpeka(''TSA0565'')',
'BRLOG_NDMKM_ECMS_MCINCBG#T112A*_NBG###Y#T',
'BRLOG_NDMKM_ECMS_MCINC#T112A*###Y#T',
'BRLOG_NDMKM_ECMS_MCINCBG#T140C*_NBG###Y#T',
'BRLOG_NDMKM_ECMS_MCINC#T140C*###Y#T',
'BRLOG_NDMKM_POSPROMET_STDTUJI#MERCATOR_*###Y#T##bk_apex_manual_cms.pak_cfg.UnskipOpek(''TSPCST2,TSPCST2A'')',
'BRLOG_NDMKM_POSPROMET_STDTUJI#NI0100EC*###Y#T##bk_apex_manual_cms.pak_cfg.UnskipOpek(''TSPCST2,TSPCST2A'')',
'BRLOG_NDMKM_POSPROMET_STDTUJI#DARS_*###Y#B##bk_apex_manual_cms.pak_cfg.UnskipOpek(''TSPCSTDA,TSPCST2A'')',
'BRLOG_NDMKM_POSPROMET_KOPER#KOPER.POSPROMET*###Y#T##bk_apex_manual_cms.pak_cfg.UnskipOpek(''TSPCSK2,TSPCSK2A'')',
'BRLOG_NDMKM_POSPROMET_KOPER#KOPER.VISAEMV.POSPROMET*###Y#T##bk_apex_manual_cms.pak_cfg.UnskipOpek(''TSPCSK2,TSPCSK2A'')',
'BRLOG_NDMKM_ECMS_INP#A_VISAINC_*###Y#T##bk_apex_manual_cms.pak_cfg.UnskipOpeka(''TSAE126'')',
'BRLOG_NDMKM_ECMS_INP#I_VISAINC_*###Y#T##bk_apex_manual_cms.pak_cfg.UnskipOpeka(''TSIV011'')',
'BRLOG_NDMKM_ECMS_INP#TC04IN_*###Y#T##bk_apex_manual_cms.pak_cfg.UnskipOpeka(''TSA0126'')',
'BRLOG_NDMKM_ECMS_INP#GAENECUR_*###Y#T##bk_apex_manual_cms.pak_cfg.UnskipOpeka(''TSA0502'')',
'BRLOG_NDMKM_ECMS_INP#GIENECUR_*###Y#T##bk_apex_manual_cms.pak_cfg.UnskipOpeka(''TSI0502'')',
'BRLOG_NDMKM_ECMS_INP#BM_*###Y#B##bk_apex_manual_cms.pak_cfg.UnskipOpek(''TSADBLK,TSA0206'')',
'BRLOG_NDMKM_ECMS_ARB#cSa_*###Y#T##bk_apex_manual_cms.pak_cfg.UnskipOpek(''TSI0287,TSI0287,TSI0287'')',
'BRLOG_NDMKM_ECMS_ARB#cSa_*###Y#T##bk_apex_manual_cms.pak_cfg.UnskipOpek(''XSPCSI3,XSPCSI5,TSPICD1,TSPICD2'')',
'BRLOG_NDMKM_ECMS_ARB#CSV_*###Y#T##bk_apex_manual_cms.pak_cfg.UnskipOpeka(''XSP0V050'')',
'BRLOG_NDMKM_ECMS_INP#INC_*###Y#T##bk_apex_manual_cms.pak_cfg.UnskipOpeka(''XSP0V050'')',
'BRLOG_NDMKM_ECMS_INP#ITF_*###Y#T',
'BRLOG_NDMKM_ECMS_INP#ADJUSTMENT_*###Y#T',
'BRLOG_NDMKM_ASTER_OUT_SMSI#SMS.OBROKI###Y#T##bk_apex_manual_cms.pak_cfg.UnskipOpeka(''GSP0SMSO'')',
'BRLOG_NDMKM_ECMS_INP#SIM_INCOMING*###Y#T',
'BRLOG_NDMKM_ECMS_INP#VISA_BIN_ARDEF*.dat###Y#T',
'BRLOG_NDMKM_ECMS_INP#MCI_REPORT_T140C1*###Y#T',
'BRLOG_NDMKM_ECMS_ARB#AZP_DIREKTNE_*###Y#T',
'BRLOG_NDMKM_ASTER_INP#PAYM_CONF_X*###Y#T',
'BRLOG_NDMKM_ECMS_OUT#POTR_TRAJ_X*###Y#T',
'NETDATA01_ADJACQ#37601_*###Y#T',
'NETDATA01_ADJACQ#37610_*###Y#T',
'NETDATA01_ADJACQ#37635_*###Y#T'))
,p_attribute_05=>'P1_FILENAME_MULTI'
,p_attribute_06=>'P1_FILEHASH_MULTI'
,p_attribute_07=>'P1_PLUGIN_LOG'
,p_process_error_message=>'Error when processing SaveToDiskMulti. SQLERRM: #SQLERRM#'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(5382774093194961)
,p_process_when=>'P1_BROWSE_FILE_MULTI'
,p_process_when_type=>'ITEM_IS_NOT_NULL'
,p_process_success_message=>'SaveToDiskMulti succeeded.'
);
end;
/
...
,p_step_template=>wwv_flow_api.id(5360967284796669)
,p_page_template_options=>'#DEFAULT#'
,p_dialog_chained=>'Y'
,p_overwrite_navigation_list=>'N'
,p_nav_list_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(5371060348796709)
,p_plug_name=>'Login'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(5364173391796680)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(5371374661796714)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(5371060348796709)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(5371183013796710)
,p_name=>'P101_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(5371060348796709)
,p_prompt=>'Username'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>40
,p_cMaxlength=>100
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(5371264836796714)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(5371554696796716)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(5371470732796714)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(5371776290796716)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(5371669990796716)
,p_process_sequence=>10
